    ...
    <div className='w-[1000px] h-screen px-10'>
      ...
      <div className='h-screen py-8'>
                        ...
                        <tr key={item._id}>
                          ...
                          <td className='py-4'>
                            <p className='text-gray-500 text-sm'>
                              {highlightText(moment(item.date).format('MMMM Do YYYY'), searchTerm)}
                            </p>
                          </td>
        ...
        <div className='text-center'>
          <Link to='/diets'>
            <button className='px-7 py-3 bg-secondary rounded-lg font-bold uppercase'>
              For more information about all the Instructors
            </button>
          </Link>
        </div>
        <br/>
