    ...
    <div className='w-[1000px] h-screen px-10'>
        <div>
          <div>
                ...
                <div className='w-[900px] shadow-lg rounded-lg p-3 flex flex-col justify-between border border-secondary overflow-hidden'>
                          ...
                          { 
                            userRecords.map((record,index)=>(
                              <div key={record._id}>
                                ...
                                <p className='text-black mb-2 text-center'><span className='font-bold'>Existing Medical Condition : </span>{record.existingMedicalCondition}
                                  <br/>
                                  {
                                    (record.existingMedicalCondition === "Yes" || record.existingMedicalCondition === "yes") && 
                                    <div className='col-span-1 md:col-span-2 lg:col-span-3 text-center text-sm text-red-700'>
                                      Due to your existing medical conditions, we reccomend you to take instructor advices before following any workout or diet!! 
                                      <br/>
                                    </div>
                                  }
                                </p>
                                <p className='text-black mb-2 text-center'><span className='font-bold'>Any Surgeries : </span>{record.anySurgeries}
                                  <br/>
                                  {
                                    (record.anySurgeries === "Yes" || record.anySurgeries === "yes") && 
                                    <div className='col-span-1 md:col-span-2 lg:col-span-3 text-center text-sm text-red-700'>
                                      Due to the surgery you went through, we reccomend you to take instructor advices before following any workout or diet!! 
                                      <br/>
                                    </div>
                                  }
                                </p>
                                <p className='text-black mb-2 text-center'><span className='font-bold'>Any Allergies : </span>{record.AnyAllergies}  
                                  <br/>
                                  {
                                    (record.AnyAllergies === "Yes" || record.AnyAllergies === "yes") && 
                                    <div className='col-span-1 md:col-span-2 lg:col-span-3 text-center text-sm text-red-700'>
                                      Due to the food allergies you are having, we reccomend you to take instructor advices before following any workout or diet!! 
                                      <br/>
                                    </div>
                                  }
                                </p>
