...
import img from '../../assets/diets/volumetrics.jpg'
export const Diets = () => {
              ...
              <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-4 '>
                {
                    diets.map((diet,index)=>(
                      <div className='shadow-lg rounded-lg p-3 flex flex-col justify-between border border-secondary overflow-hidden m-4'>
                        <div className='p-4'>
                            <h2 className='text-xl font-semibold mb-20 dark:text-white text-center'>{diet.name}</h2>
                            <img src={diet.dietImg} alt="Diet Image"/>
