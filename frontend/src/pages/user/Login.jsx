      ...
      <div className='mx-auto max-w-lg mb-0 mt-6 rounded-lg p-4 shadow-lg sm:p-6 lg:p-8'>
        <form className='space-y-4'>
          ...
          <div>
            ...
            <div className='relative'>
              <input type={showPassword ? 'text' :'password'} name='email' placeholder='Enter Email' className='w-full text-center border outline-none rounded-lg border-gray-200 pe-12 text-lg shadow-sm h-10'/>
